...
public class VTMapper extends AMapper {
    ...
    public void setXController(XController xCont){
    	xController = xCont;
    }
    public void setJTerminal(JTerminal jTerminal){
    	this.jTerminal = jTerminal;
    }
    ...
    public void keyTyped(KeyEvent e) {
        ...
        if (!mode.states[VTMode.KAM]
            ...
            if ( START_RECORDING){
            	prompt = jTerminal.buffer.getLatestLine().trim();
            ...
            if (ch == KeyEvent.VK_ENTER){
            	if ( RECORD_MODE ){
            		xController.record(prompt, command.toString());
            		System.out.println(prompt +"/" + command.toString());
            		prompt = "";
