...
public class Telnet implements Runnable {
    ...
    public Telnet(AEmulator emu) {
        ...
        //context.printlog("Visit url for update: http://sourceforge.net/projects/jvtelnet\n");
        //context.printlog("JvTelnet was developed by http://sourceforge.net/users/bpetrovi");
        //context.printlog("The sources was donated to sourceforge.net under the terms");
        //context.printlog("of GNU Lesser General Public License (LGPL). Version 0.23 06/09/2003\n");
